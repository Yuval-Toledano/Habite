          ...
          <InnerPageContainer flexDirection="row" className="justify-content-center" display="grid" background="transparent">
            <div className="rounded p-4 bg-offwhite">
              <div className="page-headline d-flex justify-content-center">
                <TextInPage>Log in to <span className="logo-small">Habite</span></TextInPage>
              </div>
              {/* forms wrapper start */}
              <div className="forms p-4 pb-0">
                <div className="form-1 p-2 pb-0">
                  <div className="mx-auto md:w-2/4">
                    {error && <div className="py-4 bg-red-600 w-full text-white text-center mb-3">{error}</div>}
                    ...
                    <form onSubmit={handleSubmit}>
                      ...
                      {/* Log in button start */}
                      <button disabled={loading} type="submit" className="Button-primary Button-wide">
                        Log in
                      </button>
                      {/* Log in button end */}
                    </form>
