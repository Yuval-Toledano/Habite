...
/**
 * the function update user info to user's document.
 */
...
/**
 * the function update the notifications of the group members.
 */
...
/**
 * the function creates new vote from userId and challengeId, and saves it to firestore server.
 */
